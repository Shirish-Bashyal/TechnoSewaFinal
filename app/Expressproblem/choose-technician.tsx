     ...
     <SafeAreaView className="bg-gray-100 h-full">
      ...
      <TouchableOpacity
        ...
        >
          ...
          <Text className="text-white   text-[20px]" style={{fontFamily:'rubik-bold' ,letterSpacing: 1.5 }}>Choose Technician</Text>
        </TouchableOpacity>
        </View>
...
export default chooseechnician